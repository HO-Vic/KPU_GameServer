...
public:
	...
	static void MoveGameObject(int playerId, std::pair<short, short>& position);
	//static void NPC_MoveGameObject(int playerId, std::pair<short, short>& position);
...
public:
	...
	//static std::list<pair<short, short>> GetAstarList_list(int npcId, pair<short, short>& targetPos);
...
private:
	...
	//static void InsertOpenList(const std::list<int, AstarNode>& closeList, std::list<int, AstarNode>& openList, pair<short, short>& targetNode, pair<short, short>& parentNode, short nextNodeX, short nextNodeY);
